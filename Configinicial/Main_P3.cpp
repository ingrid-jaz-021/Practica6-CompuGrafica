...
int main() {
 ...
 //     
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::rotate(model, 4.5f, glm::vec3(0.0f, 1.0f, 0.0f));
		...
		model = glm::mat4(1);
		// Caracteristicas
		model = glm::translate(model, glm::vec3(1.0f, 4.14f, 0.0f));
		model = glm::rotate(model, 5.0f, glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::scale(model, glm::vec3(2.5f, 1.3f, 1.5f));
		// Mandar la info al Shader y dibujar
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
		...
		model = glm::mat4(1);
		// Caracteristicas
		model = glm::translate(model, glm::vec3(1.8f, 5.62f, 0.0f));
		...
		model = glm::mat4(1);
		// Caracteristicas
		model = glm::translate(model, glm::vec3(3.0f, 7.7f, 0.0f));
		model = glm::rotate(model, 3.8f, glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::scale(model, glm::vec3(1.0f, 2.4f, 1.5f));
		// Mandar la info al Shader y dibujar
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
